"""
Student name(s): Nathaniel Alvarez, Dereje Lambert
Student email(s): nalvarez@caltech.edu, dlambert@caltech.edu

We have implemented an online video game store, similar to Steam, where 
users can search games, look at trailers, descriptions, and critic ratings, and 
also buy the game. The motivation behind creating this application was a 
combination of a love for video games, and coming across an extensive dataset 
with multiple useful columns.
"""
